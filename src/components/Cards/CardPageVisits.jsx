  ...
  const toggleEdit = () => {
   ...
   //fetch addnewbuilding //
     ...
     const handleSubmit = (e) => {
       ...
       formData.append("BuildingManager", buildingManager);

       axios({
         url: "https://smart-parking-api-3g3e.onrender.com/parking/buildings/addNewBuilding",
         method: "POST", 
         data: formData, 
         headers: {
           Authorization: `Bearer ${token}`,
    ...
    "https://smart-parking-api-3g3e.onrender.com/parking/buildings/deleteBuilding/" + id
                    ...
                    >
                      ...
                      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4 flex space-x-3">
                        ...
                        <span className=" text-red-600">
                          <FaTrash onClick={() => deleteBuilding(items._id)} />
                        </span>
                      </td>
                    </tr>
                  );
